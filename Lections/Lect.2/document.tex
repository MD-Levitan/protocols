...
\begin{document}
	...
	\frame {
		...
		\begin{center}
			\textbf{17 занятий * 2 часа + коллоквиум  * 2 часа = 36 часa}
			
			\bigskip
			
			\textbf{$80\%$ посещений и успешная сдача коллоквиума гарантирует автомат на экзамене}
		\end{center}
	}
	\frame {
		\begin{figure}
			\includegraphics[width=\linewidth]{index.jpeg}
